...
#Buttons
button1=Button(tab1,text="Reset",command=clear_text, width=12,bg='#b9f6ca')
button1.grid(row=4,column=0,padx=10,pady=10)

button2=Button(tab1,text="Summarize",command=get_summary, width=12,bg='blue',fg='#fff')
button2.grid(row=4,column=1,padx=10,pady=10)

button3=Button(tab1,text="Clear Result", command=clear_display_result,width=12,bg='#03A9F4',fg='#fff')
button3.grid(row=5,column=0,padx=10,pady=10)

button4=Button(tab1,text="Close", width=12,command=window.destroy,bg='#03A9F4',fg='#fff')
...
# BUTTONS
button1=Button(tab3,text="Reset",command=clear_url_entry, width=12,bg='#b9f6ca')
button1.grid(row=4,column=0,padx=10,pady=10)
...
button4=Button(tab3,text="Summarize",command=get_url_summary, width=12,bg='blue',fg='#fff')
button4.grid(row=4,column=2,padx=10,pady=10)

button4=Button(tab3,text="Close", width=12,command=window.destroy,bg='#03A9F4',fg='#fff')
button4.grid(row=5,column=1,padx=10,pady=10)
# Display Screen For Result
